<?php
// HTTP
define('HTTP_SERVER', 'http://dipherente.com/admin/');
define('HTTP_CATALOG', 'http://dipherente.com/');

// HTTPS
define('HTTPS_SERVER', 'http://dipherente.com/admin/');
define('HTTPS_CATALOG', 'http://dipherente.com/');
