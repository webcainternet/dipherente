					...
					<?php if ($thumb || $images) { ?>
							...
							<div class="image-thumb" style="width: 155px; margin-left: 10px !important; ">
								<ul id="image-additional">
									...
									<?php if (!empty($thumb)) { ?>
									<li style="width: 117px !important; max-width: 117px !important;" >
										<a class="active" href="#" data-image="<?php echo $thumb; ?>" data-zoom-image="<?php echo $popup; ?>">
											<img style="width: 117px;" src="<?php echo $thumb; ?>" alt="" />
										</a>
									</li>
									<?php } ?>
									<?php foreach ($images as $image) { ?>
									<li style="width: 117px !important; max-width: 117px !important;" >
										<a href="#" data-image="<?php echo $image['popup']; ?>" data-zoom-image="<?php echo $image['popup']; ?>"> <img style="width: 117px;" src="<?php echo $image['thumb']; ?>" alt="" /> </a>
									</li>
									<?php } ?>
				...
				<div>
					<div class="product-thumb transition">
						...
						<div class="caption">
							...
							<?php
								$query = $this->db->query("SELECT oc_manufacturer.name as autor, oc_product.* FROM oc_product  left join oc_manufacturer on oc_product.manufacturer_id =  oc_manufacturer.manufacturer_id WHERE product_id = ".$product['product_id']);
