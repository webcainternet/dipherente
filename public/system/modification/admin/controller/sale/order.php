...
$data['tab_copu'] = $this->language->get('tab_copu');
				...
				$data['copu_product_js'] = $this->load->controller('myoc/copu/product', array('js' => true, 'customer_id' => $data['customer_id']));
					...
					if ($option['type'] != 'file') {
						...
						if ($upload_info) {
							$option_data[] = array(
								...
								'value' => $upload_info['name'],
								'type'  => $option['type'],
'value' => $upload_info['name'] . '</a> [' . formatFilesize(filesize(DIR_UPLOAD . $upload_info['filename'])) . ']<a>',
...
$data['text_upload'] = $this->language->get('text_upload');
				$data['tab_copu'] = $this->language->get('tab_copu');
				$data['copu_order'] = $this->load->controller('myoc/copu', array('type' => 'order', 'edit' => false));
...
$data['copu_order'][$order_id] = $this->load->controller('myoc/copu/invoice', array('order_id' => $order_id));
			$order_info = $this->model_sale_order->getOrder($order_id);
