...
$data['copu_cart'][$product['order_product_id']] = $this->load->controller('myoc/copu/cart', array('order_id' => $this->request->get['order_id'], 'order_product_id' => $product['order_product_id']));
				$data['products'][] = array(
...
$data['copu_history'] = $this->load->controller('myoc/copu', array('type' => 'order'));
			$data['column_left'] = $this->load->controller('common/column_left');
			$data['column_right'] = $this->load->controller('common/column_right');
			$data['content_top'] = $this->load->controller('common/content_top');
			$data['content_bottom'] = $this->load->controller('common/content_bottom');
