...
if($this->config->get('copu_customer_status') && $this->config->get('copu_customer_register') && $this->config->get('copu_customer_stores') && in_array($this->config->get('config_store_id'), $this->config->get('copu_customer_stores')) && $this->config->get('copu_customer_email_attachment') && isset($this->session->data['copu_customer_uploads']) && !empty($this->session->data['copu_customer_uploads'])) {
